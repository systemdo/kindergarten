...
class Families
{
     ...
     * @ORM\JoinColumn(name="parentage_id", referencedColumnName="id")
     */
    ...
    /**
     * @ORM\OneToOne(targetEntity="Address")
     * @ORM\JoinColumn(name="address_job_id", referencedColumnName="id")
     **/
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Children", mappedBy="family")
     **/
